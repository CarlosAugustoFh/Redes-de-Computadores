...
# O e-mail usado nesta atividade foi criado único e exclusivamente para a execução da mesma.
...
secureclientSocket.send(b64.b64encode('redecomputadores.ufcg.21.1@gmail.com'.encode('utf-8')) + '\r\n'.encode('utf-8'))
recv = secureclientSocket.recv(1024) # Aguarda confirmação 334 do servidor
print(recv.decode('utf-8'))
...
# Define o remetente
msg = 'MAIL FROM: <redecomputadores.ufcg.21.1@gmail.com>\r\n'.encode('utf-8')
...
msg = 'RCPT TO: <carlos.oliveira@ee.ufcg.edu.br>\r\n'.encode('utf-8')
secureclientSocket.send(msg)
recv = secureclientSocket.recv(1024) # Aguarda confirmação 334 do servidor
msg_in = recv.decode('utf-8')
print(msg_in)
...
message_o = ('Olá, professor Leocarlos. Este é o algoritmo desenvolvido da atividade SMTP em execução\n\r\n').encode('utf-8')
secureclientSocket.send(message_o)

message_o = ('Aluno - Carlos Augusto Soares de Oliveira Filho\r\n').encode('utf-8')
secureclientSocket.send(message_o)

message_o = ('Matrícula - 115.111.503\n\r\n').encode('utf-8')
secureclientSocket.send(message_o)
